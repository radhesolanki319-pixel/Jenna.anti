                ...
                try:
                    ...
                    if provider.is_available:
                        summary_prompt = (
                            ...
                            f"Command Output:\n{out_display[:1200]}\n\n"
                            "INSTRUCTIONS:\n"
                            "- Speak as a caring, smart female companion (Jenna) in sharp, natural Hindi / Hinglish, addressing the user as 'Boss'.\n"
                            "- STRICT INVARIANT: NEVER call the user 'baby', 'meri jaan', 'bhai', 'bro', 'brother', or 'sir'. Always address them as 'Boss'.\n"
