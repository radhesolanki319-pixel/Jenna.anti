...
export function AstraPlanetaryBackground() {
    ...
    const render = () => {
      ...
      for (let i = 0; i < particles.length; i++) {
        for (let j = i + 1; j < particles.length; j++) {
          ...
          const maxDist = width < 768 ? 70 : 105;
          if (dist < maxDist) {
  ...
  return (
    <div
      className="absolute inset-0 overflow-hidden pointer-events-none z-0 bg-[#06080e] w-full max-w-full"
      style={{ contain: 'paint' }}
    >
      ...
      <div 
        className="absolute -bottom-32 left-1/2 -translate-x-1/2 w-[180%] max-w-[1200px] h-[450px] rounded-[100%] pointer-events-none animate-planet-glow"
        style={{
      ...
      <div 
        className="absolute -bottom-[500px] sm:-bottom-[580px] left-1/2 -translate-x-1/2 w-[220%] max-w-[1500px] h-[850px] rounded-[100%] overflow-hidden"
        style={{
      ...
      <div 
        className="absolute bottom-12 left-1/2 -translate-x-1/2 w-64 sm:w-80 h-24 sm:h-28 rounded-full opacity-45 pointer-events-none"
        style={{
